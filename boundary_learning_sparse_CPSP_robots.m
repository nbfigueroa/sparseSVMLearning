...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tt_ratio = 0.2; % This can go up to 500k points!
...
svmlwrite('./svm_perf/robotCollision/36d-240k-NewIIWASetup-Feb18-Points.dat', X_train, y_train)
svmlwrite('./svm_perf/robotCollision/36d-240k-NewIIWASetup-Feb18--Testing.dat', X_test(1:testSamples,:), y_test(1:testSamples,:))
...
clear y_test X_test
[y_test, X_test] = svmlread(strcat(foldername,'36d-240k-NewIIWASetup-Feb18--Testing.dat'));

%% Load Predictions
foldername = './svm_perf/robotCollision/';
prediction_names = dir('./svm_perf/robotCollision/36d-240k-NewIIWASetup-Feb18-Predictions.dat'); 
...
optimal_model_name = '36d-240k-NewIIWASetup-Feb18-Model.dat';
